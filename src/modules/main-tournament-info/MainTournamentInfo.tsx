...
const MainTournamentInfo: React.FC = () => {
    ...
    const onRegisterClick = (isAuthorized: boolean, url: URL) => {
    ...
    return (
        <>
            ...
            <ul className={style.buttons}>
                <li className={style.button}><button onClick={() => onRegisterClick(store.isAuthorized, url)}>Зарегистрироваться</button></li>
